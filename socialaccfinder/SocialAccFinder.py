...
class SocialAccFinderFuturesSession(FuturesSession):
    def request(self, method, url, hooks={}, *args, **kwargs):
        ...
        return super(SocialAccFinderFuturesSession, self).request(method,
                                                           url,
                                                           hooks=hooks,
                                                           *args, **kwargs)
...
def SocialAccFinder(username, site_data, query_notify,
    ...
    session = SocialAccFinderFuturesSession(max_workers=max_workers,
...
def main():
    ...
    for username in args.username:
        results = SocialAccFinder(username,
                           site_data,
                           query_notify,
                           tor=args.tor,
        ...
        with open(result_file, "w", encoding="utf-8") as file:
            ...
            file.write(f"Total websites this username was detected on: {exists_counter}\n")
