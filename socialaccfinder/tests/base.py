...
class SocialAccFinderBaseTest(unittest.TestCase):
    def setUp(self):
        """SocialAccFinder Base Test Setup.

        Does common setup tasks for base SocialAccFinder tests.
        ...
        excluded_sites_path = os.path.join(os.path.dirname(os.path.realpath(SocialAccFinder.__file__)), "tests/.excluded_sites")
        try:
    ...
    def username_check(self, username_list, site_list, exist_check=True):
        ...
        for username in username_list:
            results = SocialAccFinder.SocialAccFinder(username,
                                        site_data,
                                        self.query_notify,
                                        tor=self.tor,
